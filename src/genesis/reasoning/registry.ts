 ...
 *
 * Responsible only for managing reasoning strategies.
...
export class ReasoningStrategyRegistry {
   ...
   */
  public register(strategy: ReasoningStrategy): void {
    if (!strategy) {
   ...
   */
  public getStrategies(): readonly ReasoningStrategy[] {
    const sorted = Array.from(this.strategies.values()).sort((a, b) => a.id.localeCompare(b.id));
    return Object.freeze(sorted);
  }

  /**
   * Clears all registered strategies. Useful for testing isolation.
   */
  public clear(): void {
